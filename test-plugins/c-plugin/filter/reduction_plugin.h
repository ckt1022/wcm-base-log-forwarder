...
#ifndef __BINDINGS_REDUCTION_PLUGIN_H
#define __BINDINGS_REDUCTION_PLUGIN_H
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct reduction_plugin_string_t {
  uint8_t*ptr;
  size_t len;
} reduction_plugin_string_t;

typedef struct {
  reduction_plugin_string_t f0;
  reduction_plugin_string_t f1;
} reduction_plugin_tuple2_string_string_t;

typedef struct {
  reduction_plugin_tuple2_string_string_t *ptr;
  size_t len;
} reduction_plugin_list_tuple2_string_string_t;

typedef struct {
  reduction_plugin_string_t *ptr;
  size_t len;
} reduction_plugin_list_string_t;

typedef struct {
  bool is_some;
  reduction_plugin_string_t val;
} reduction_plugin_option_string_t;
...
typedef struct {
  uint8_t *ptr;
  size_t len;
} reduction_plugin_list_u8_t;

typedef struct {
  bool is_err;
  union {
    reduction_plugin_list_u8_t ok;
...
typedef struct wasi_filesystem_types_directory_entry_t {
  wasi_filesystem_types_descriptor_type_t   type;
  reduction_plugin_string_t   name;
...
typedef struct {
  reduction_plugin_list_u8_t f0;
  bool f1;
} reduction_plugin_tuple2_list_u8_bool_t;

typedef struct {
  bool is_err;
  union {
    reduction_plugin_tuple2_list_u8_bool_t ok;
    wasi_filesystem_types_error_code_t err;
  } val;
...
typedef struct wasi_sockets_udp_incoming_datagram_t {
  reduction_plugin_list_u8_t   data;
...
typedef struct {
  uint64_t f0;
  uint64_t f1;
} reduction_plugin_tuple2_u64_u64_t;
...
typedef struct local_log_process_pipeline_process_parsed_entry_t {
  reduction_plugin_string_t   timestamp;
  local_log_process_pipeline_process_log_level_t   level;
  reduction_plugin_string_t   message;
  reduction_plugin_list_tuple2_string_string_t   tags;
  reduction_plugin_string_t   targettag;
...
typedef struct local_log_process_pipeline_process_parse_error_t {
  uint8_t tag;
  union {
    reduction_plugin_string_t     invalid_format;
...
typedef struct local_log_process_pipeline_process_plugin_error_t {
  uint8_t tag;
  union {
    reduction_plugin_string_t     invalid_input;
    reduction_plugin_string_t     processing_failed;
    reduction_plugin_string_t     config_error;
    uint64_t     unknown_id;
  } val;
...
typedef struct local_log_process_pipeline_process_enrich_result_t {
  ...
  reduction_plugin_list_tuple2_string_string_t   additional_tags;
...
typedef struct local_log_process_pipeline_process_route_result_t {
  ...
  reduction_plugin_list_string_t   urls;
} local_log_process_pipeline_process_route_result_t;

typedef local_log_process_pipeline_process_log_entry_t reduction_plugin_log_entry_t;

typedef local_log_process_pipeline_process_filter_result_t reduction_plugin_filter_result_t;

typedef local_log_process_pipeline_process_plugin_error_t reduction_plugin_plugin_error_t;

typedef struct {
  reduction_plugin_log_entry_t *ptr;
  size_t len;
} reduction_plugin_list_log_entry_t;

typedef struct {
  reduction_plugin_filter_result_t *ptr;
  size_t len;
} reduction_plugin_list_filter_result_t;
...
} reduction_plugin_result_list_filter_result_plugin_error_t;
...
extern void wasi_cli_environment_get_environment(reduction_plugin_list_tuple2_string_string_t *ret);
// Get the POSIX-style arguments to the program.
extern void wasi_cli_environment_get_arguments(reduction_plugin_list_string_t *ret);
// Return a path that programs should use as their initial current working
// directory, interpreting `.` as shorthand for this.
extern bool wasi_cli_environment_initial_cwd(reduction_plugin_string_t *ret);
...
// hazard.
extern void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, reduction_plugin_string_t *ret);
...
extern void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, reduction_plugin_list_u32_t *ret);
...
extern bool wasi_io_streams_method_input_stream_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, reduction_plugin_list_u8_t *ret, wasi_io_streams_stream_error_t *err);
// Read bytes from a stream, after blocking until at least one byte can
// be read. Except for blocking, behavior is identical to `read`.
extern bool wasi_io_streams_method_input_stream_blocking_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, reduction_plugin_list_u8_t *ret, wasi_io_streams_stream_error_t *err);
...
extern bool wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, reduction_plugin_list_u8_t *contents, wasi_io_streams_stream_error_t *err);
...
// ```
extern bool wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, reduction_plugin_list_u8_t *contents, wasi_io_streams_stream_error_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_read(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_filesize_t length, wasi_filesystem_types_filesize_t offset, reduction_plugin_tuple2_list_u8_bool_t *ret, wasi_filesystem_types_error_code_t *err);
extern bool wasi_filesystem_types_method_descriptor_write(wasi_filesystem_types_borrow_descriptor_t self, reduction_plugin_list_u8_t *buffer, wasi_filesystem_types_filesize_t offset, wasi_filesystem_types_filesize_t *ret, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_create_directory_at(wasi_filesystem_types_borrow_descriptor_t self, reduction_plugin_string_t *path, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_stat_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, reduction_plugin_string_t *path, wasi_filesystem_types_descriptor_stat_t *ret, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_link_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t old_path_flags, reduction_plugin_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, reduction_plugin_string_t *new_path, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_readlink_at(wasi_filesystem_types_borrow_descriptor_t self, reduction_plugin_string_t *path, reduction_plugin_string_t *ret, wasi_filesystem_types_error_code_t *err);
extern bool wasi_filesystem_types_method_descriptor_remove_directory_at(wasi_filesystem_types_borrow_descriptor_t self, reduction_plugin_string_t *path, wasi_filesystem_types_error_code_t *err);
extern bool wasi_filesystem_types_method_descriptor_rename_at(wasi_filesystem_types_borrow_descriptor_t self, reduction_plugin_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, reduction_plugin_string_t *new_path, wasi_filesystem_types_error_code_t *err);
extern bool wasi_filesystem_types_method_descriptor_symlink_at(wasi_filesystem_types_borrow_descriptor_t self, reduction_plugin_string_t *old_path, reduction_plugin_string_t *new_path, wasi_filesystem_types_error_code_t *err);
extern bool wasi_filesystem_types_method_descriptor_unlink_file_at(wasi_filesystem_types_borrow_descriptor_t self, reduction_plugin_string_t *path, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_metadata_hash_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, reduction_plugin_string_t *path, wasi_filesystem_types_metadata_hash_value_t *ret, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_sockets_ip_name_lookup_resolve_addresses(wasi_sockets_ip_name_lookup_borrow_network_t network, reduction_plugin_string_t *name, wasi_sockets_ip_name_lookup_own_resolve_address_stream_t *ret, wasi_sockets_ip_name_lookup_error_code_t *err);

// Imported Functions from `wasi:random/random@0.2.0`
extern void wasi_random_random_get_random_bytes(uint64_t len, reduction_plugin_list_u8_t *ret);
extern uint64_t wasi_random_random_get_random_u64(void);

// Imported Functions from `wasi:random/insecure@0.2.0`
extern void wasi_random_insecure_get_insecure_random_bytes(uint64_t len, reduction_plugin_list_u8_t *ret);
extern uint64_t wasi_random_insecure_get_insecure_random_u64(void);

// Imported Functions from `wasi:random/insecure-seed@0.2.0`
extern void wasi_random_insecure_seed_insecure_seed(reduction_plugin_tuple2_u64_u64_t *ret);

// Exported Functions from `reduction-plugin`
bool exports_reduction_plugin_filter(reduction_plugin_list_log_entry_t *struct_data, reduction_plugin_list_filter_result_t *ret, reduction_plugin_plugin_error_t *err);
