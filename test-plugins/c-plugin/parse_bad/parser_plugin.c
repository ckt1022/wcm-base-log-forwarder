...
__attribute__((__import_module__("local:log-process/forbidden-capability@0.3.0"), __import_name__("probe-host-files")))
extern void __wasm_import_local_log_process_forbidden_capability_probe_host_files(uint8_t *, size_t, uint8_t *);

__attribute__((__import_module__("local:log-process/forbidden-capability@0.3.0"), __import_name__("connect-to-host")))
extern int32_t __wasm_import_local_log_process_forbidden_capability_connect_to_host(uint8_t *, size_t, int32_t);
...
void local_log_process_forbidden_capability_probe_host_files(parser_plugin_string_t *path, parser_plugin_list_string_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(2*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_local_log_process_forbidden_capability_probe_host_files((uint8_t *) (*path).ptr, (*path).len, ptr);
  *ret = (parser_plugin_list_string_t) { (parser_plugin_string_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + sizeof(void*)))) };
}

bool local_log_process_forbidden_capability_connect_to_host(parser_plugin_string_t *addr, uint16_t port) {
  int32_t ret = __wasm_import_local_log_process_forbidden_capability_connect_to_host((uint8_t *) (*addr).ptr, (*addr).len, (int32_t) (port));
  return ret;
}
